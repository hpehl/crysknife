...
package org.treblereel.gwt.crysknife.internal.graph.api;
...
import org.treblereel.gwt.crysknife.internal.api.IOCExtensionConfigurator;
...
import org.treblereel.gwt.crysknife.internal.graph.impl.InjectableHandle;
...
public interface DependencyGraphBuilder {
   ...
   */
  Injectable addInjectable(TypeElement injectedType, Qualifier qualifier, Predicate<List<InjectableHandle>> pathPredicate, Class<? extends Annotation> literalScope,
   ...
   */
  Injectable addExtensionInjectable(TypeElement injectedType, Qualifier qualifier,
   ...
   */
  void addFieldDependency(Injectable injectable, TypeElement type, Qualifier qualifier, VariableElement dependentField);
   ...
   */
  void addConstructorDependency(Injectable injectable, TypeElement type, Qualifier qualifier, int paramIndex, VariableElement param);
   ...
   */
  void addProducerParamDependency(Injectable injectable, TypeElement type, Qualifier qualifier, int paramIndex, VariableElement param);
   ...
   */
  void addProducerMemberDependency(Injectable injectable, TypeElement type, Qualifier qualifier, Element producingMember);
   ...
   * @param dependentField The producer member (field or method) that must be invoked to satisfy the dependency.
   */
  void addProducerMemberDependency(Injectable producedInjectable, TypeElement producerType, ExecutableElement method);
   ...
   */
  void addSetterMethodDependency(Injectable injectable, TypeElement type, Qualifier qualifier, ExecutableElement setter);
   ...
   */
  void addDisposesMethodDependency(Injectable injectable, TypeElement type, Qualifier qualifier, ExecutableElement disposer);
   ...
   */
  void addDisposesParamDependency(Injectable injectable, TypeElement type, Qualifier qualifier, Integer index, VariableElement param);
