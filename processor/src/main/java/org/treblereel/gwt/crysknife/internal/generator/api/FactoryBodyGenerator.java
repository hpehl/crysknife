...
package org.treblereel.gwt.crysknife.internal.generator.api;
...
import org.treblereel.gwt.crysknife.FactoryGenerator;
 ...
 * {org.treblereel.gwt.crysknife.client.Factory} subclasses.
 *
...
public interface FactoryBodyGenerator {
  ...
  void generate(ClassStructureBuilder<?> bodyBlockBuilder, Injectable injectable, DependencyGraph graph,
                InjectionContext injectionContext, GeneratorContext context);
}
