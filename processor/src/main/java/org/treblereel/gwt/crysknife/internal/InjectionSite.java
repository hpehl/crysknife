...
import org.treblereel.gwt.crysknife.internal.api.HasAnnotations;
...
public class InjectionSite implements HasAnnotations {
  ...
  public InjectionSite(final TypeElement enclosingType, final HasAnnotations annotated, final Collection<Injectable> otherResolvedInjectables) {
  ...
  public String getUniqueName() {
    return enclosingType.getQualifiedName().toString() + "_" + annotatedName();
  }
